...
-   What changed about the graph when you added `theme_common()`?
    ...
    -   Legend title and font are larger

    -   X and Y axis labels are larger

    -   Grid lines are now gray instead of white

    -   Plot margins are slightly different
...
mpg %>%
  ...
  theme(
    ...
    axis.title.x = element_text(margin = margin(4, 4, 44, 4), size = 16, angle = 258),
    axis.title.y = element_text(margin = margin(4, 4, 4, 4), size = 16, angle = 9)
  )
```
