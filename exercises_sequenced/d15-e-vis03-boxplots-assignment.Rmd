...
diamonds %>%
  mutate(carat_cut = cut_number(carat, n = 20 )) %>%
...
-   As carat goes up, the median price goes up.

-   There is some overlap between subsequent boxes, but upper and lower
    quantiles also increase with carat.

-   The whiskers are more spread out as carat increases
...
-   It did! The most common group of cut and color is now premium and I
    colored.
