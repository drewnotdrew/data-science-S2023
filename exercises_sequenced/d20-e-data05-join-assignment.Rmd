...
-   Binding column in this way does not take into account the order of
    the rows - so the data gets mixed up and is no longer correct.
...
```{r q3-task}
criteria <- expand_grid(month = c(8, 9), dest = c("SFO", "SJC", "OAK"))
