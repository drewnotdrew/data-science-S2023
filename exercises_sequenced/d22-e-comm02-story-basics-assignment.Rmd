...
-   Conveys that price increases with carat, but decreases with cut for
    carat under 1.
...
-   Too much conflict and information! It's difficult to make sense of
    anything beyond the smooth line plots.
...
-   It's difficult to draw any conclusions - there's not really any
    conflict, and therefore no pattern to recognize without looking at
    it for a while.
