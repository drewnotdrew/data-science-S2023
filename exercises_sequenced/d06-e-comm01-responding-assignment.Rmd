...
-   Is the bolded response **active** or **passive**? Why?
    -   Active, because the presenter engages with the issue at hand.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   The response is constructive, because the presenter acknowledges the issue and does not make the colleague feel as though it is their fault.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   Positive. The previous statement blew off the colleague, but this response acknowledged them.
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive. The presenter does not knowledge the missing axes.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Constructive, because the presenter does not trivialize the issue.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   Better, but it makes it seem as though the presenter does not care about the graph with missing axes.
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive. The question completely sidesteps the presentation with a topic that is unrelated.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   The question isn't really constructive or destructive in nature, but it's off topic enough that I think it is destructive.
