...
```{r ex-cor-line}
slope <- 0.01 # Play with this value; observe the correlation
df_line <-
...
-   What do you predict the correlations to be?
    -   Because we are using the Pearson method, I think it will be very small.
