...
**Observations**: - The hypothesis was incorrect - there are a lot of
ideal cut diamonds. In fact, diamonds with a better cut are, in general,
more common than worse cut diamonds.
...
**Observations**: - The plot does not directly support or contradict
hypothesis 2. It is difficult to glean much information from this graph
because the dots are to large and overlap each other. Overplotting!
...
**Observations**: - This boxplot contradicts the hypothesis. The cut of
a diamond does not appear to affect the cost of the diamond. However,
ideal cut diamonds are the least expensive.
...
**Observations**: - Ideal cut diamonds have a lower median carat, so it
does appear that diamond cutters sacrifice carat for a better quality
cut. However, this sacrifice does not raise the median price.
