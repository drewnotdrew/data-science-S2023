...
**Observations**: - Because we do not have an aesthetic applied to one
of the columns of the mpg data, they just stack up in the bar graph.
...
-   Which visualization---`v1` or `v2`---enabled you to make more
    observations?
    -   v2 enabled me to make more observations, because additional info
        is presented.
-   What was the difference between `v1` and `v2`?
    -   The drivetrain composition of each car class is easily
        displayed, whereas in the first graph the colors are more or
        less useless.
...
**Observations** - Some manufacturers only create certain classes of
vehicles, while others diversify.
