...
They are the same functionally, but one uses the pipe operator while the
other does not.
...
The function `group_by()` groups the data, after which subsequent
functions act on each group of data separately.
